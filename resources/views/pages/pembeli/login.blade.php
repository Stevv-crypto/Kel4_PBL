    ...
    <div class="w-2/5 bg-[#ACC8DD] px-8 py-[150px] rounded-xl shadow-md">
        ...
        <form class="space-y-8 mt-12">
            ...
            <div class="flex justify-between space-x-4 items-center w-full">
                <a href="/login" class="bg-[#70B9EA] text-white py-3 px-5 w-32 rounded-md text-center text-sm hover:bg-blue-600 transition-colors">Login</a>
                <a href="#" class="text-black hover:underline">Forget Password?</a>
            </div>
        </form>
        <p class="mt-4 text-sm text-gray-700"> Don't have an account?
            <a href="/login" class="text-blue-600 underline">Register</a>
        </p>
    </div>
</section>
