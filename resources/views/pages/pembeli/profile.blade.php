    ...
    <div class="max-w-2xl mx-auto mt-8 md:mt-10 p-6 bg-white shadow-md rounded-xl">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <input type="text" id="Name"
          class="mt-1 block w-full bg-[#e8dedd] px-3 py-2 rounded border border-gray-300 focus:ring-2 focus:ring-blue-500"
          placeholder="Astore" />
        </div>
        <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <textarea id="address" rows="4"
          class="mt-1 block w-full bg-[#e8dedd] px-3 py-2 rounded border border-gray-300 resize-none focus:ring-2 focus:ring-blue-500"
          placeholder="Jl. Ahmad Yani Batam Kota"></textarea>
        </div>
        <div>
